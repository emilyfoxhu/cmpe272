<?php
    extract($_POST);
    setcookie("Torreja", 1 + $_COOKIE['Torreja'], time() + 60*5);
    setcookie("Torreja", 1 + $_COOKIE['Chiffon_Cake'], time() + 60*5, "/", "http://dzaivc.com/user_tracking.php", 1 );
...
<div class="container">
  ...
  <section>
    ...
    <article class="left_article">
      <h3>&nbsp;</h3>
      <h3>Torreja</h3>
	  <p>Torreja is similar to French toast, first soaked in cinnamon, milk, etc., and then fried on fire, so the outer skin is soft and the inner is sweet. With caramel, cinnamon, honey, etc., it is a very pleasant afternoon snack.</p>
	  <p><strong>Price: $8.50</strong></p>
	  <p>Calories 2904.8kJ/1005.0kcal</p>
      <p>Protein 79.9g</p>
	  <p>Carbohydrates 201.3g</p>
	  <p>Fat 55.8g</p>
	  <p>Fiber 0.9g</p>
        <br/><br/>
        ...
        <form method = "post" action = "process.php">
            ...
            <input type="hidden" name="type" value="Torreja">
            <p>
...
<strong></strong>    </article>
    <aside class="right_article"><img src="../images/product10.jpg" alt="" width="750" height="500" class="placeholder"/> </aside>
  </section>
  <div class="row"> </div>
