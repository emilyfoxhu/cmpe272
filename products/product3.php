<?php
    extract($_POST);
    setcookie("Matcha_Cake", 1 + $_COOKIE['Matcha_Cake'], time() + 60*5);
    setcookie("Matcha_Cake", 1 + $_COOKIE['Chiffon_Cake'], time() + 60*5, "/", "http://dzaivc.com/user_tracking.php", 1 );
    ...
    <article class="left_article">
      ...
      <p>Fiber 2.8g</p>
        ...
        <form method = "post" action = "process.php">
            ...
            <input type="hidden" name="type" value="Matcha_Cake">
            <p>
