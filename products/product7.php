    ...
    <article class="left_article">
	  ...
	  <p>Fiber 4.2g</p>
        ...
        <form method = "post" action = "process.php">
            ...
            <input type="hidden" name="type" value="Turron">
            <p>
...
<strong></strong>    </article>
    <aside class="right_article"><img src="../images/product7.jpg" alt="" width="750" height="500" class="placeholder"/> </aside>
  </section>
  <div class="row"> </div>
